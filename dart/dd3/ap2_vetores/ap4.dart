...
void chamarMenu() {
  print(
      "Seja Bem-Vindo!\n1-Vetores Aleatórios\n2-Vetores Escolhidos\n3-Vetores Somados\nescolha: ");
  String? resposta = stdin.readLineSync();

  switch (resposta) {
    case "1":
      imprimirVetoresAleatorios();
      print("-------------------");
      return chamarMenu();
    case "2":
      imprimirVetoresEscolhidos();
      print("-------------------");
      return chamarMenu();
    case "3":
      imprimirVetoresSomados();
      print("-------------------");
      return chamarMenu();
    default:
      print("Inválido");
...
void imprimirVetoresAleatorios() {
  int tamanhoDaLista = pegarTamanhoDoVetor();
  List<int> vetorValoresAleatorios =
      pegarVetorValoresAleatorios(tamanhoDaLista);

  int tamanhoVetor = vetorValoresAleatorios.length;
  print(
      "Seu vetor com tamanho ${tamanhoVetor} com valores aleatórios: ${vetorValoresAleatorios}");
}

void imprimirVetoresEscolhidos() {
  int tamanhoDaLista = pegarTamanhoDoVetor();
  List<double> vetorValoresEscolhidos = pegarVetorValoresEscolhidos(tamanhoDaLista);

  int tamanhoVetor = vetorValoresEscolhidos.length;
  print("Seu vetor com tamanho ${tamanhoVetor} com valores aleatórios: ${vetorValoresEscolhidos}");
}
